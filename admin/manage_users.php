...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    ...
    <button onclick="showAddModal()"
        class="px-6 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg">
        ➕ เพิ่มผู้ใช้
    </button>
</div>
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <?php if ($user['id'] !== $_SESSION['user_id'] && $user['repair_count'] == 0): ?>
                                    <form method="POST" class="inline" id="deleteForm<?= $user['id'] ?>">
                                        ...
                                        <button type="button"
                                            onclick="confirmDelete(<?= $user['id'] ?>, '<?= e($user['fullname']) ?>')"
